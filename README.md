...
[![License](https://img.shields.io/github/license/adrian-gadient/fuji-recipe-tagger)](LICENSE)
...
``` bash
# 1. Extract EXIF data
./scripts/macOS/get_exif.sh
# When prompted, drag your photos folder and output folder

# 2. Match recipes
./scripts/macOS/identify_recipes.sh
# Drag: metadata CSV, recipes.csv, output folder

# 3. Tag photos
./scripts/macOS/add_recipes.sh
# Drag: matched_recipes.csv
```
...
refine the documentation. To develop the tests and implement them in
